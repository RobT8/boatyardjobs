...
export default function GuidelinesPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <h2 className="mt-8 text-lg font-bold text-navy-800">Banner specs</h2>
      ...
      <h2 className="mt-8 text-lg font-bold text-navy-800">Content rules</h2>
      ...
      <h2 className="mt-8 text-lg font-bold text-navy-800">Billing</h2>
      ...
      <div className="mt-10">
        <Link
          href="/advertise"
          className="inline-block rounded-md bg-brass-400 px-6 py-3 font-semibold text-navy-900 hover:bg-brass-500"
        >
          Start your advert →
        </Link>
      </div>
